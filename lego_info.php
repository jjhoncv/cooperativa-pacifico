...
<head>
  ...
  <title>Lego - Lista de Leads</title>
...
function activa(){
    ...
    xmlhttp8.open("GET", "ajax_abi?func=4&agente1="+agente1+"&agente2="+agente2+"&agente3="+agente3);
    xmlhttp8.send(); 
...
function eliminar(){
    ...
    xmlhttp1.open("GET", "delete?tabla=Abi&id="+id);
    xmlhttp1.send(); 
    setInterval("location.reload()",1000);
	}
}
...
<input type='hidden' id='dni' name='dni'>
 <table class="table table-responsive table-striped">
    <thead>
        <tr>
            <th>
                <form action="lego_info" method="get" name="cuerpo" autocomplete="off">
			...
			<button type='button' class='btn btn-warning' data-toggle='modal' data-target='#Vamos'>Desembolsado</button> <a class="btn btn-danger" href="desconectar?pag=lego_info" role="button">Desconectar</a></th> 
        </td>
    </thead>
 </table>
 <table class="table table-responsive table-striped">
...
<body>
<br>
<form action="login_pdp2?pagina=lego_info" method="post" name="cuerpo" autocomplete="off">
