...
include_once 'apipersonas.php';
	...
	$_SESSION["repetido"] = "vacio";
	$api->repetidoDni_api($dni);
	
	if($_SESSION["repetido"]=="true")
	{
	...
	if($Deuda_impaga<500 and $calificacion_socio=="OK" and $saldo_pagar>587 and $encontrado=="V")
    {
    ...
    if($Deuda_impaga<500 and $calificacion_socio=="OK" and $saldo_pagar>549 and $encontrado=="V")
    {
    ...
    if($Deuda_impaga<500 and $calificacion_socio=="OK" and $saldo_pagar>510 and $encontrado=="V")
    {
    ...
    if($Deuda_impaga<500 and $calificacion_socio=="OK" and $saldo_pagar>472 and $encontrado=="V")
    {
    ...
    if($Deuda_impaga<500 and $calificacion_socio=="OK" and $saldo_pagar>428 and $encontrado=="V")
    {
    ...
    if($Deuda_impaga<500 and $calificacion_socio=="OK" and $saldo_pagar>407 and $encontrado=="V")
    {
    ...
    if($Deuda_impaga<500 and $calificacion_socio=="OK" and $saldo_pagar>341 and $encontrado=="V")
    {
    ...
    if($Deuda_impaga<500 and $calificacion_socio=="OK" and $saldo_pagar>275 and $encontrado=="V")
    {
	...
	if(($calificacion_socio=="NOR" or $calificacion_socio=="CPP" or $calificacion_socio=="SC") and ($calificacion_socio1=="" or $calificacion_socio1=="NOR" or $calificacion_socio1=="CPP") and $encontrado=="V" and $Deuda_impaga<500)
	{
	...
	/*
	if($score > 699 and $Deuda_impaga<500 and $encontrado=="V"){
	...
	*/
	...
	$api->tarjetasPendientes_sandbox('XIOMI');
	$xiomi = $_SESSION["XIOMI"];
	//$xiomi = 100;

	$api->tarjetasPendientes_sandbox('KAORI');
	$kaori = $_SESSION["KAORI"];
	//$kaori = 100;

	$api->tarjetasPendientes_sandbox('JOHANN');
	$johann = $_SESSION["JOHANN"];
    //$johann = 100;
		...
		$api->feriado($fecha);
			...
			if($_SESSION["miguel_t"]!="true")
			{
				if ($desde < $hora_actual and $hasta > $hora_actual) 
				{
					...
					{
						$funcionario = "XIOMI LLAMADA"; // LLAMADA
					}
					else
					{
						$funcionario = "XIOMI WSP";
					}
				}
				else
				{
		...
		$api->feriado($fecha);
			...
			if($_SESSION["miguel_t"]!="true")
			{
				if ($desde < $hora_actual and $hasta > $hora_actual) 
				{
					if($dia==1 or $dia==2 or $dia==3 or $dia==4 or $dia==5 or $dia==6 or $dia==7)
					{
						$funcionario = "KAORI LLAMADA"; // LLAMADA
					}
					else
					{
						$funcionario = "KAORI WSP";
					}
				}
				else
				{
	...
	{
		header("Location: https://cp.com.pe/pacifico/solicita-tu-prestamo_exito-2/");
        exit();
	}
?>
