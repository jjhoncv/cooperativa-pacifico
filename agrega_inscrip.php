...
*/		
				$correo_1 = "";
				$nombre = "Patty - Paulo";
				$url = "https://cooperativapacifico.online/kyodai";
				$titulo = "Nuevo prospecto en el Tablero de Kyodai";
				
				$detalle = $ApePat . " " . $ApeMat . " " . $Nom;

				$new->sendPost_email_kyodai($correo_1,$nombre,$url,$titulo,$detalle);
