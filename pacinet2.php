...
<body>
    <div class="container">
		...
		<input type="hidden" name="usuario" id="usuario" value="<?php echo $_SESSION["acceso_pacinet"];?>">
            <br>
              <div class="mb-3">
                ...
                <input type="text" id="doi" name="doi" size="30" placeholder="C車digo de socio o DNI">
		...
		<h3>迆ltimos eventos</h3>
		<?php $new->getListadoPacinet_api(); ?>
		<hr>
		<a class="btn btn-danger" href="desconectar?pag=pacinet" role="button">&#920; Cerrar sesi車n</a>
...
<div class='modal fade' id='Crear' tabindex='-1' role='dialog' aria-labelledby='exampleModalCenterTitle' aria-hidden='true'>
    <div class='modal-dialog modal-dialog-centered' role='document'>
        ...
        <div class='modal-body'>
							...
							<input type="text" name="correo1" id="correo1" size="45" placeholder="Ingresa tu correo de la Cooperativa Pac赤fico">
							
							<br><br>
							Se enviar芍 un link para completar el proceso
            </div>
            <div class='modal-footer'>
                <button type='button' class='btn btn-secondary' data-dismiss='modal'>Close</button>
...
<div class='modal fade' id='Olvido' tabindex='-1' role='dialog' aria-labelledby='exampleModalCenterTitle' aria-hidden='true'>
    <div class='modal-dialog modal-dialog-centered' role='document'>
        <div class='modal-content'>
            <div class='modal-header'>
                <h3 class='modal-title' id='exampleModalLongTitle'>
					Olvido de clave (En mantenimiento)
					</h3>
            </div>
        <div class='modal-body'>
				
							<input type="text" name="correo2" id="correo2" size="45" placeholder="Ingresa tu correo de la Cooperativa Pac赤fico">
