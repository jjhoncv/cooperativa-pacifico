...
function abrir_carta_primera(session)
{
		...
		xhttp2.open("GET", "ajax_abrir_carta_memoria?func=1&session="+session+"&equipo="+equipo, true);
		xhttp2.send();
...
function juego_nuevo(session)
{
		...
		xhttp5.open("GET", "ajax_abrir_carta_memoria?func=4&session="+session, true);
		xhttp5.send();
...
<body onload="carga()">
    <div class='container'>
        <div class='row'>
			...
			<tr>
				...
				<td class='text-center'><div id="titulo"><h4><b>Memoria</b></h4></div></td>
				<td>
					<div id="crono">
	...
	<div id='tiempo' align='center'></div>
