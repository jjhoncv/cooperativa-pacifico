...
$subir_archivo = $directorio.basename(htmlspecialchars($sanatize_archivo['name']));
$mensaje ="";
...
{
    if (move_uploaded_file(htmlspecialchars($sanatize_archivo['tmp_name']), $subir_archivo)) {
