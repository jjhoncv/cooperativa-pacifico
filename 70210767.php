...
function agrega(){
    ...
    xmlhttp4.open("POST", "agrega_agencias2?dni="+dni+"&nombres="+nombres+"&codigo="+codigo+"&agencia="+agencia+"&correo="+correo+"&celular="+celular+"&observaciones="+observaciones+"&funcionario="+funcionario+"&canal="+canal+"&tarea="+tarea,true);
    xmlhttp4.send(); 
    setInterval("location.reload()",1000);
